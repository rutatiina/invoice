...
class CreateRgInvoicesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('tenant')->create('rg_invoices', function (Blueprint $table) {
            ...
            $table->unsignedDecimal('discount', 20, 5)->nullable();
            $table->unsignedDecimal('discount_percentage', 42, 38)->nullable()->default(0);
    ...
    {
        Schema::connection('tenant')->dropIfExists('rg_invoices');
    }
}
