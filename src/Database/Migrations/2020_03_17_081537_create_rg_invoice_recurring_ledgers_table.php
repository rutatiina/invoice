...
class CreateRgInvoiceRecurringLedgersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('tenant')->create('rg_invoice_recurring_ledgers', function (Blueprint $table) {
    ...
    {
        Schema::connection('tenant')->dropIfExists('rg_invoice_recurring_ledgers');
    }
}
