...
class InvoiceItemTax extends Model
{
    ...
    protected $table = 'rg_invoice_item_taxes';
    ...
    {
        return $this->belongsTo('Rutatiina\Invoice\Models\Invoice', 'invoice_id', 'id');
    }

    public function invoice_item()
    {
        return $this->belongsTo('Rutatiina\Invoice\Models\InvoiceItem', 'invoice_item_id', 'id');
    }
