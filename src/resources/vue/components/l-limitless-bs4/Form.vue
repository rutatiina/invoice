            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-item">Invoices</span>
                    ...
                    <form v-if="!this.$root.loading"
                        ...
                        <fieldset class="">
                            ...
                            <div class="form-group row">
                                ...
                                <label class="col-lg-1 col-form-label text-right" style="white-space: nowrap;">
                                    Due Date:
                                </label>
                                <div class="col-lg-2">
                            ...
                            <div class="form-group row">
                                <table class="table table-bordered border-left-0 border-right-0 border-bottom-0">
                                    ...
                                    <tbody class="border-0">
                                        ...
                                        <!-- todo update discount input xx
                                        <tr>
                                            <td class="p-15 border-0"></td>
                                            <td class="p-15 border-left-0 border-top-0 border-right-0 font-weight-bold" colspan="2">Discount</td>
                                            <td class="border-left-0 border-top-0 border-right-0 text-right pr-0">
                                                <div class="input-group">
                                                    <input type="text"
                                                           v-model="txnAttributes.discount_amount"
                                            ...
                                            <td class="border-left-0 border-top-0 border-right-0 text-right pr-0">
                                                <div class="input-group">
                                                    <input type="text"
                                                           v-model="txnAttributes.discount_amount"
                                                           readonly
                                                           class="rg-txn-item-row-total form-control text-right border-0 bg-transparent"
                                                           placeholder="0.00">
                                                    <span class="input-group-append border-0 rounded-0">
                                                        <button type="button"
                                                                class="btn bg-danger bg-transparent text-danger btn-icon"
