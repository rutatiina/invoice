        ...
        <div class="page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title d-flex">
                    <h4><i class="icon-drawer3 mr-2"></i> <span class="font-weight-semibold">Recurring Invoice</span></h4>
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr class="table-active">
                                ...
                                <th scope="col" class="font-weight-bold">Frequency</th>
                                <th scope="col" class="font-weight-bold">Start date</th>
                                <th scope="col" class="font-weight-bold">End date</th>
                        ...
                        <tbody>
                            ...
                            <tr v-for="row in tableData.payload.data"
                                ...
                                <td class="cursor-pointer">{{row.recurring.frequency}}</td>
                                <td class="cursor-pointer">{{row.recurring.start_date}}</td>
                                <td class="cursor-pointer">{{row.recurring.end_date}}</td>
...
<script>
    ...
    export default {
        name: 'AccountingSalesRecurringInvoices',
        //components: {},
        data() {
            return {}
        },
        ...
        methods: {
            onRowClick(txn) {
                //console.log(txn)
                this.$router.push({ path: '/recurring-invoices/'+txn.id })
            }
        },
        ready:function(){},
